...
for ID in subhaloIDs:
    ...
    preprocess.prepare() # prepare for simulation, including retrieving particles and creating .ski file
...
### Outputs
`./dataCubes` are the IFU-like dataCubes of **SubhaloID** generated by SKIRT, if `saveDataCube == True`  
