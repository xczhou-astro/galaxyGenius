...
`./mock_HSC` includes the bandpass images and SEDs of **SubhaloID** for HST.  
...
└── Subhalo_(ID)/
    ...
    ├── galaxy_view_(ViewID).png # Plot of selected bandpass or RGB images
    └── all_bands_view_(ViewID).png # Plot of bandpass images in all bands
```
